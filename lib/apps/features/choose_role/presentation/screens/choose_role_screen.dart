...
import 'package:doctor_hunt/apps/features/choose_role/presentation/controller/choose_role_bloc.dart';
import 'package:doctor_hunt/apps/features/choose_role/presentation/controller/choose_role_event.dart';
import 'package:doctor_hunt/apps/features/choose_role/presentation/controller/choose_role_state.dart';
                      ...
                      onTap: () {
                        ...
                        const AdminLoginRoute().push(context);
                                      ...
                                      child: RoleWidget(
                                        ...
                                        roleIcon:
                                            AppAssets.icons.adminIcon.path,
                                        selected:
                                            selectedRole.value ==
                                            UserRoles.admin,
                                    ...
                                    GestureDetector(
                                      ...
                                      child: RoleWidget(
                                        ...
                                        roleIcon:
                                            AppAssets.icons.patientIcon.path,
                                        selected:
                                            selectedRole.value ==
                                            UserRoles.patient,
                  ...
                  onPressed: () {
                    context.read<ChooseRoleBloc>().add(
                      UpdateUserRoleRequested(
                        user: currentUser!.copyWith(role: selectedRole.value),
                      ),
                    );
                  },
                  child: Text(
